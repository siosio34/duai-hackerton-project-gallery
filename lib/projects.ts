...
export const projects: Project[] = [
  {
    ...
    prologue: {
      intro: "비 내리는 밤, 도시의 가장 낮은 골목. 두두는 가진 것 없는 파란 블롭이다. 배달 일을 마치고 식은 피자 한 조각 앞에 앉았을 때, 낡은 외투의 노인이 다가온다.",
      lines: [
        { speaker: "노인", text: "이거 하나 가져가라. 비트코인이라고, 들어는 봤지?" },
        { speaker: "두두", text: "이런 걸로… 제가 뭘 할 수 있는데요?" },
        { speaker: "노인", text: "위로 올라가. 높이 오를수록 값이 오른다. 대신 발을 헛디디면 전부 잃어." },
      ],
      outro: "두두는 고개를 들었다. 네온 사이로 까마득한 수직 도시, 그 꼭대기의 펜트하우스가 깜빡이고 있었다. 올라가는 수밖에 없다.",
    },
    features: [
