...
export const projects: Project[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "구독 새 글 알림 — RSS·Fanding·US-Insight 유료 구독 소스의 신규 글을 감지해 5줄 요약·핵심 포인트·종목/섹터 태그로 펼친다. 약관을 존중해, 집에 띄워 둔 에이전트 PC의 로그인된 브라우저에 Chrome CDP로 붙는 본인 인증 세션 기반 read-only로만 수집한다.",
    ],
    outcome:
